        ...
        <div className="seccion-resena">
            {estaEditando ? (
                <div className="entradas-resena">
                    ...
                    />
                    {errores.texto && (
                        <p className="mensaje-error" role="alert" id={`${idResena}-error`}
                    ...
                    {errores.puntaje && (
                        <p className="mensaje-error" role="alert" id={`${idPuntaje}-error`}
                ...
                <div className="resena-guardada">
                    ...
                    <Boton type="button" variante="secundario" className="boton-accion"
                           onClick={manejarEditarResena}>Editar</Boton>
                </div>
            )}
        </div>
    )
