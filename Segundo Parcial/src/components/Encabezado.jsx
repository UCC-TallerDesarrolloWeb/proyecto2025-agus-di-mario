        ...
        {esInicio ? (
          <>
            ...
            <div className="app-header__field">
              ...
              <select id="filtro-artista" value={valorArtista} onChange={(evento) => alCambiarFiltro?.(evento.target.value)}>
            ...
            {alLimpiar && (
              <Boton id="boton-limpiar" variante="peligro" onClick={manejarLimpiar} title="Limpiar todos los datos guardados">Limpiar</Boton>
            )}
